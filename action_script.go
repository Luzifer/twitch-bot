...
func (a ActorScript) Execute(c *irc.Client, m *irc.Message, r *plugins.Rule, eventData plugins.FieldCollection, attrs plugins.AttributeStore) (preventCooldown bool, err error) {
...
func (a ActorScript) Validate(attrs plugins.AttributeStore) (err error) {
